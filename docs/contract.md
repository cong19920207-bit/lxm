...
- **布局**：**`.diary-hero`** 头图 **`/static/images/diary/dary_ri.png`**；**`.diary-main`** 列表区 **`margin-top: -17vh`**（与头图渐变叠压，小屏 **`-100px`**）；返回钮见摘要「淡薰衣草圆钮」；**`body.h5-skin.diary-page`** 页面底 **`#f3f0ff`**（覆盖全站 neo 渐变底，仅本页）。
